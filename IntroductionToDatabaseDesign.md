...
2. **Data Domain** – refers to all the values that might be contained in a Data Element.  In laymen’s terms the range of data that can be stored.  In most cases it is restricted by choosing a Data Type for a Column.
